...
function mainMenu(){
    ...
    const alienTitle = createToDom("img", ["class", "alien-title"], logoContainer, "images/alienTitle.png")
    const blasterTitle = createToDom("img", ["class", "blaster-title"], logoContainer, "images/blasterTitle.png")
    const logoTitle = createToDom("img", ["class", "logo-title"], logoContainer, "images/logoTitle.png")
